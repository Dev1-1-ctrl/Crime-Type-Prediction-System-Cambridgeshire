...
# Make a table for LSOA-month with one row for each LSOA times month.
...
# Create synthetic context features at LSOA level
#     - deterministic by LSOA
...
lsoa_baselines = pd.DataFrame({
    ...
    "education_index_base": rng.uniform(0.4, 0.85, size=len(lsoas)),
    # Demographics
    # ppl/km2
...
# Keeping the synthetic columns to merge back
synthetic_cols = [
