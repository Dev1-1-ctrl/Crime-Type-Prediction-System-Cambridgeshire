...
# setting True to oversample minority classes
...
#  MISSING CHECKS
# Important fields that must be present and not null
...
# SELECTIBG FEATURES
# features always used:
base_feats = ["Year", "Month_num", "Season",
              "Latitude", "Longitude", "LSOA_encoded"]

# If synthetic columns is in, include them automatically
synthetic_feats = [
...
# Encoders to decode predictions
